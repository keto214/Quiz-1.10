...
class UsersTable extends AbstractTableGateway
{
	...
	public function fetchAllAccounts($paginated = false)
	{
		...
		if($paginated) {
			...
			// Please not that Laminas\Paginator\Adapter\DbSelect is deprecated

			// install the laminas-paginator-adapter-laminasdb component by using the following command
			// composer require laminas/laminas-paginator-adapter-laminasdb

			// then instead of using the Laminas\Paginator\Adapter\DbSelect class
			// use Laminas\Paginator\Adapter\LaminasDb\DbSelect class instead
		...
		$inputFilter->add(
			$factory->createInput(
				[
					...
					'required' => true,
					'filters' => [
						['name' => Filter\StripTags::class], # strips html tags
